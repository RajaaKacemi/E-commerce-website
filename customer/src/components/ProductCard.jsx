  ...
  return (
    <div className='w-auto cursor-pointer'>
      <div className=' flex justify-center items-center h-full'>
        <div className='card w-64 h-full bg-white border m-3 rounded-2xl overflow-hidden' onClick={() => navigate(`/product/${product && product._id}`)}>
          ...
          <div className='flex justify-center'>
            <div className='flex flex-col w-60 pt-2 pb-2'>
              <div className='px-6 mb-3 flex flex-row justify-center truncate'>
